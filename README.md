...
- Part I: Fetch the list of proposals when the component mounts
...
- Part II.a: Fetch related data to replace the codes with the actual descriptions
...
- Part II.b: Fetch other related data similar to above for other data being displayed
...
- Part III: Tie filtering into the proposal search so that when you click the filter button it only shows relevant results
